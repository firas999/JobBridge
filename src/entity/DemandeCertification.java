...
public class DemandeCertification {
   ...
   private String    email;
    ...
    public DemandeCertification(int id, int certification_id, String nom_participant, String prenom_participant, Date date_demande, String experience_participant, String email) {
        this.id = id;
    ...
    public DemandeCertification(int certification_id, String nom_participant, String prenom_participant, Date date_demande, String experience_participant, String email) {
        this.certification_id = certification_id;
        this.nom_participant = nom_participant;
        this.prenom_participant = prenom_participant;
        this.date_demande = date_demande;
    ...
    public String toString() {
        return "DemandeCertification{" + "id=" + id + ", certification_id=" + certification_id + ", nom_participant=" + nom_participant + ", prenom_participant=" + prenom_participant + ", date_demande=" + date_demande + ", experience_participant=" + experience_participant + ", email=" + email + '}';
    }
