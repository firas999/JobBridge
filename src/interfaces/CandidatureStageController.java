...
public class CandidatureStageController implements Initializable {
    ...
    List<CandidatStage> lr = ps.readAll();
    ObservableList<CandidatStage> list = FXCollections.observableArrayList(lr);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        identreprise_candidaturestage.setCellValueFactory(new PropertyValueFactory<>("identreprise_id"));
        idstagiaire_candidaturestage.setCellValueFactory(new PropertyValueFactory<>("idstagiaire_id"));
        ...
        if (entreprise_candidaturestage.getSelectionModel().isEmpty() || stagiaire_candidaturestage.getSelectionModel().isEmpty() || email_candidaturestage1.getText().equals("")) {
            ...
            Mail.sendMail(email_candidaturestage1.getText());
             Notifications notificationBuilder = Notifications.create()
                    ...
                    .text("Candidature stage ajouter")
                    .graphic(null)
    ...
    private void modifier(ActionEvent event) throws IOException {
        ...
        ps.modifier(p);
        System.out.println(email_candidaturestage1.getText());
        Parent root = FXMLLoader.load(getClass().getResource("CandidatureStage.fxml"));
