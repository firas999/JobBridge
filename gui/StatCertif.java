...
public class StatCertif  {
   ...
   Resources theme ; 
     ...
     */
    protected CategorySeries buildCategoryDataset(String title, ArrayList<Certification> ab) {
        CategorySeries series = new CategorySeries(title);

        for (Certification u : ab) {
    ...
    public void createPieChartForm(String titre, ArrayList<Certification> ab) {
        // Generate the values
